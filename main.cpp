...
private:
    ...
    void Print()
    {
        std::cout << "orig res mass" << std::endl;
        ...
        while (count < result.size())
        {
            if (!isNumber(result[count]))
            {
                ...
                // std::cout << "update res mass" << std::endl;
                // for (unsigned int i = 0; i < result.size();i++) {
                //     std::cout << result[i] << std::endl;
                // }
            }
    ...
    void Count()
    {
        ...
        std::cout << root->elem->Calculate() << std::endl;
    }
